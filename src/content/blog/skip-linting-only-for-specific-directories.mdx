...
<Picture
  formats={['webp', 'jpeg']}
  src="https://images.microcms-assets.io/assets/3ab7834809eb4654a5239e79fba895de/7e435cf46a1848f3a17554e16f19e026/error-export-default.jpg?auto=format"
  alt="export defaultを利用しようとするとエラーになる"
  aspectRatio="16:3"
  widths={[480, 600, 720]}
